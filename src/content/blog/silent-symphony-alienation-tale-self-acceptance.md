...
```text
New day for person with resilience 2, sensitivity 1, and optimism 3.

Experiencing: wearing_mask
Doubt intensity: 9
Fear intensity: 9
Rejection intensity: 9
Joy intensity: 9
Excitement intensity: 9
Sadness intensity: 9
Anger intensity: 9
Acceptance intensity: 6
Belonging intensity: 9
Recognition intensity: 9
Achievement intensity: 9

Experiencing: realization
Doubt intensity: 10
Fear intensity: 10
Rejection intensity: 10
Joy intensity: 10
Excitement intensity: 10
Sadness intensity: 10
Anger intensity: 10
Acceptance intensity: 10
Belonging intensity: 10
Recognition intensity: 10
Achievement intensity: 10
```

![Output-1](https://llego.dev/assets/output-1.png)
...
Experiencing: door_closed
Doubt intensity: 8
Fear intensity: 8
Rejection intensity: 10
Joy intensity: 8
Excitement intensity: 8
Sadness intensity: 8
Anger intensity: 8
Acceptance intensity: 7
Belonging intensity: 10
Recognition intensity: 10
Achievement intensity: 10
...
![Output-2](https://llego.dev/assets/output-2.png)
...
Sadness intensity: 10
Anger intensity: 10
Acceptance intensity: 8
Belonging intensity: 8
Recognition intensity: 8
...
![Output-3](https://llego.dev/assets/output-3.png)
...
![Output-4](https://llego.dev/assets/output-4.png)
...
![Output-5](https://llego.dev/assets/output-5.png)
